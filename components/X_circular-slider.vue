<template>
  <div :class="['slider-container', { stacked }]">
    <div :class="`grid-noGutter${reverseGrid ? '-reverse' : ''}`">
      ...
      <div
        :class="leftCols.num"
        :data-push-left="leftCols.push_left"
        :data-push-right="leftCols.push_right">
      ...
      <div
        :class="rightCols.num"
        :data-push-left="rightCols.push_left"
        :data-push-right="rightCols.push_right">
...
export default {
  ...
  computed: {
    ...
    leftCols () {
      return this.gridCols.left
    },
    rightCols () {
      return this.gridCols.right
    },
    currentSlide () {
